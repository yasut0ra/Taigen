...
BEGIN
  ...
  IF NOT EXISTS (SELECT FROM pg_tables WHERE tablename = 'goals') THEN
    CREATE TABLE goals (
  ...
  IF NOT EXISTS (SELECT FROM pg_tables WHERE tablename = 'milestones') THEN
  ...
  IF NOT EXISTS (SELECT FROM pg_tables WHERE tablename = 'progress_updates') THEN
